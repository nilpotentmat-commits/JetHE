...
from slim_crypto_v2 import SlimRing as TerminalRing
from slim_crypto_v2 import make_bank
from analysis.slim_bounds_v2 import FRESH, WIDTH, CHAIN, trace_spec
...
def setup(ring, coins):
    ...
    assert sum(len(b.rows) for b in banks.values()) == 134 and coins.errors == 139
