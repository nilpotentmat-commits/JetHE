// New terminal W1/W2 comparator. Does not modify/replay the W0 drivers.
...
int main(int argc,char** argv) {
  try {
    ...
    const auto desc=profile(*ctx,*ea,bits,arm);
    if(mode=="profile") {
    ...
    require(ctx->securityLevel()>=128,"Fails preliminary library security screen");
