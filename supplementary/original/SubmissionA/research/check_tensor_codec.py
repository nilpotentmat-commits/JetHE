"""Explicit public binary tensor codec; no encrypted codec or timing claim.

CRT setup is constructed and inverted here, not supplied as a dense N*N map.
Counts describe logical bit XORs, not Python big-integer machine costs.
"""
...
from check_frobenius_compiler import Field, Jets
