"""Candidate-only setup using the original samplers and row constructor.

Importing this module generates nothing. A caller must explicitly supply the
ring and a fresh original Coins object. No discarded original Hasse rows are
generated, and no independently sampled error is replaced by a derived sum.
"""
